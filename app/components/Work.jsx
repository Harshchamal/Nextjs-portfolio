        ...
        <h2 className='text-center text-5xl font-Ovo'>My Portfolio</h2>
         ...
         <div className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
           {workData.map((project, index)=>(
               ...
               relative cursor-pointer group ' style={{backgroundImage: `url(${project.bgImage})`}}>

                <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 
                px-5 flex item-center justify-between duration-500 group-hover:bottom-7'>
         ...
         text-gray-700 border-[0.5px] border-gray-700 rounded-fully py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white 
